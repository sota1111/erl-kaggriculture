...
> bank 順 r1-15-sol-low-p3 > r1-14-sol-low-p1 > r1-13-sol-low-p1
> マージン順 r1-15-sol-low-p3 > r1-13-sol-low-p1 > r1-14-sol-low-p1
> どちらが実LBの順位を保存するかは未検証であり、現時点でローカル順位を昇格判定に使ってはならない。

> **アーム内のばらつき(bank)最大 3,234 対 アーム間の差 6,440。**ばらつきが差と同程度以上であり、**軸の効果を語ってはならない。**
